...
const ServicesPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* ------------------- HERO BANNER ------------------- */}
      <header className="relative flex min-h-[100vh] w-full md:items-top bg-[url('./images/services_hero.webp')] bg-cover bg-bottom font-sans  text-white overflow-hidden px-6 py-0 md:px-12 md:py-10 lg:px-10">
